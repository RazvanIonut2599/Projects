...
public abstract class Character extends Item
{
    ...
    public static final float DEFAULT_SPEED         = 4f; /*!< Viteza implicita a unu caracter.*/
    ...
    public static int DefaultCharacterWidth = Tile.TILE_WIDTH-60;
    public static int DefaultCaractherHeight=Tile.TILE_HEIGHT-20;
     ...
     */
    public Character(RefLinks refLink, float x, float y)
    {
            ///Apel constructor la clasei de baza
        super(refLink, x,y, DefaultCharacterWidth, DefaultCaractherHeight);
