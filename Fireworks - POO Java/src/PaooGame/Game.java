...
import PaooGame.Options.DataBaseManager;
...
public class Game implements Runnable
{
    ...
    private State loadState;            /*!< Referinta catre load.*/
    private State overState;            /*!< Referinta catre GameOver.*/
    ...
    private void InitGame()
    {
        ...
        loadState       = new LoadingState(refLink);
        overState       = new GameOverState(refLink);
    ...
    public synchronized void StopGame()
    {
        if(runState == true)
        {
            ...
            {
                //UPDATE HIGHSCORES!!!!
                DBManager.pasteOptions();
                DBManager.pasteMilestones();
    ...
    public void setState(String state){
        ...
        switch (state)
        {
            case "MENU":{State.SetState(this.menuState); break;}
            case "PLAY":{ State.SetState(this.playState);break;}
            case "ABOUT":{State.SetState(this.aboutState);break;}
            case "OVER":{State.SetState(this.overState);break;}
            case "LOAD":{State.SetState(this.loadState);break;}
            case "PAUSE":{State.SetState(this.pauseState);break;}
            case "OPT":{State.SetState(this.settingsState);break;}
